...
public class SOMFunction {
	public static JavaRDD<String> filterPerfData(JavaRDD<String> data,
			final String regex) {
	...
	public static JavaRDD<String> filterVMName(JavaRDD<String> data,
			final String regex) {
		JavaRDD<String> ret = data.filter(new Function<String, Boolean>() {
			...
			public Iterable<String> call(String t) throws Exception {
				return Arrays.asList(new JSONObject(t).getString("name")
						+ "@@"
						+ new JSONObject(t).getJSONObject("summary")
								.getJSONObject("vm").getString("val"));
			}
	...
	public static JavaPairRDD<String, ArrayList<Double[]>> pairData(
			JavaRDD<String> data, final int size) {
		JavaPairRDD<String, ArrayList<Double[]>> ret = data
				.mapToPair(new PairFunction<String, String, ArrayList<Double[]>>() {
					@Override
					public Tuple2<String, ArrayList<Double[]>> call(String str)
						...
						return new Tuple2<String, ArrayList<Double[]>>(keep[0],
								list);
					}
	...
	public static JavaRDD<String> prepareMap(JavaRDD<String> data) {
		JavaRDD<String> ret = data.flatMap(
				new FlatMapFunction<String, String>() {
					...
					public Iterable<String> call(String t) throws Exception {
						...
						int counterId;
						String name = jObj.getJSONObject("entity").getString(
								"val");
						...
						return Arrays.asList(name + "@@" + receive + "@@"
								+ transfer);
					}
	...
	public static JavaRDD<Integer> prepareData(JavaRDD<String> data) {
		JavaRDD<Integer> size = data.flatMap(
